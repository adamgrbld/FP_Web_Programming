            ...
            <form action="edituser.jsp" method="post">
                ...
                <table>
                    ...
                    <tr>
                        <td>Sex:</td>
                        <td>
                            <input type="radio" name="sex" value="male" style="margin-right: 5px;" />Male
                            <input type="radio" name="sex" value="female"
                                style="margin-right: 5px;margin-left: 10px;" />Female
                        </td>
                    </tr>
                    <tr>
                        <td>Country:</td>
                        <td><input type="text" name="country" value="<%= u.getCountry()%>" /></td>
                    </tr>
                    <tr>
                        <input type="submit" value="Edit User" class="login">
                    </tr>
                </table>
            </form>
        </div>
