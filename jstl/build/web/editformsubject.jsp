        ...
        <div class="form">
            <form action="editsubject.jsp" method="post">
                ...
                <table>
                    ...
                    <tr>
                        <td>Lecturer:</td>
                        <td><input type="text" name="lecturer" value="<%= u.getLecturer()%>" /></td>
                    </tr>
                    <tr>
                        <td>Semester:</td>
                        <td><input type="number" name="semester" value="<%= u.getSemester()%>" /></td>
                    </tr>
                    <tr>
                        <td>Description:</td>
                    ...
                    <tr>
                        <input type="submit" value="Edit Subject" class="login">
                    </tr>
                </table>
            </form>
        </div>
